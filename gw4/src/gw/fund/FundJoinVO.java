...
public class FundJoinVO {
	...
	public void setFund_item(String fund_item) {
		this.fund_item = fund_item;
	}
	public String getFund_briefs() {
		return fund_briefs;
	}
	public void setFund_briefs(String fund_briefs) {
		this.fund_briefs = fund_briefs;
	}
