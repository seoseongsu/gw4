...
public class ProductSoftVO {
	...
	private int product_num; // 장비 번호(시퀀스)
 	private String sw_product_code; // 하드웨어 장비 코드 (시리얼 넘버)
	...
	public int getProduct_num() {
		return product_num;
			...
			public Timestamp getProduct_register_day() {
				return product_register_day;
			}
			public void setProduct_register_day(Timestamp product_register_day) {
