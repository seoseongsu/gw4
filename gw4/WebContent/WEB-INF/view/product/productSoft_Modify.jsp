...
<form method="post" name="modify" action="productSoft_ModifyPro.do?product_num=${productSoftList.product_num}">
	...
	<table id="border_table" border="1" cellspacing="0" cellpadding="0" width="500" align="center">
		...
		<tr>
			...
			<th>물품 등록일</th>
			<td ><input type="text"  id="product_register_day"  style="width:98%" name="product_register_day" value="${productSoftList.product_register_day}" onclick="fnPopUpCalendar(product_register_day,product_register_day,'yyyy-mm-dd')"></td>	
		</tr>
