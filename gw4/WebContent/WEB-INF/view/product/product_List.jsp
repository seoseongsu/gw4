...
<table id="border_table" border="1" align="left" width="1200">
				<tr>
					<th width="100">분류</th>
	...
	<c:forEach var="productList" items="${productList}">
				<tr align="center">
					...
					<input type="button" class="buttonS" value="수정" 
						onclick="javascript:window.open('product_Modify.do?product_num=${productList.product_num}','new','left=50, top=50, width=1000, height=500')">
...
<input type="button" value="물품 등록"	class="button" onclick="javascript:window.open('product_Insert.do','new','left=50, top=50, width=1000, height=500')"></td>
</tr>
</table>
