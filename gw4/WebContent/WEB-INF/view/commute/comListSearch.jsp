...
<table border="1" width="80%">
	<tr>
		<td>
			* 기간별검색 &nbsp;&nbsp;&nbsp;
			<input type="text" name="searchDate1" id="searchDate1" value="${checkDay1 }" onclick="fnPopUpCalendar(searchDate1,searchDate1,'yyyy-mm-dd')"/>~
			<input type="text" name="searchDate2" id="searchDate2" value="${checkDay2 }" onclick="fnPopUpCalendar(searchDate2,searchDate2,'yyyy-mm-dd')"/>
		</td>
		<td>
