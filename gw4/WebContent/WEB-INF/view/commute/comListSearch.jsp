...
<form name="comSearch" action="/gw4/commute/comListSearch.do" onSubmit="return checkIt()">
<table id="border_table" border="1" align="left" width="70%">
	<tr>
		...
		<td colspan="3">
			<input type="text" style="border: 1px solid;" name="searchDate1" id="searchDate1" value="${checkDay1 }" onclick="fnPopUpCalendar(searchDate1,searchDate1,'yyyy-mm-dd')"/>~
			<input type="text" style="border: 1px solid;" name="searchDate2" id="searchDate2" value="${checkDay2 }" onclick="fnPopUpCalendar(searchDate2,searchDate2,'yyyy-mm-dd')"/>
		</td>
		...
		<td>
			...
			<input type="button" class="button" value="전체" onclick="window.location='/gw4/commute/comList.do'"/>
		</td>
	</tr>
</form>
	<tr>
