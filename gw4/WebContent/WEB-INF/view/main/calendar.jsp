...
<link rel="stylesheet" type="text/css" href="/gw4/css/frontierCalendar/jquery-frontier-cal-1.3.2.css" />

<!-- Include CSS for color picker plugin (Not required for calendar plugin. Used for example.) -->
<link rel="stylesheet" type="text/css" href="/gw4/css/colorpicker/colorpicker.css" />

<!-- Include CSS for JQuery UI (Required for calendar plugin.) -->
<link rel="stylesheet" type="text/css" href="/gw4/css/jquery-ui/smoothness/jquery-ui-1.8.1.custom.css" />
...
-->
<script type="text/javascript" src="/gw4/js/jquery-core/jquery-1.4.2-ie-fix.min.js"></script>

<!-- Include JQuery UI (Required for calendar plugin.) -->
<script type="text/javascript" src="/gw4/js/jquery-ui/smoothness/jquery-ui-1.8.1.custom.min.js"></script>

<!-- Include color picker plugin (Not required for calendar plugin. Used for example.) -->
<script type="text/javascript" src="/gw4/js/colorpicker/colorpicker.js"></script>

<!-- Include jquery tooltip plugin (Not required for calendar plugin. Used for example.) -->
<script type="text/javascript" src="/gw4/js/jquery-qtip-1.0.0-rc3140944/jquery.qtip-1.0.js"></script>
...
-->
<script type="text/javascript" src="/gw4/js/lib/jshashtable-2.1.js"></script>

<!-- Include JQuery Frontier Calendar plugin -->
<script type="text/javascript" src="/gw4/js/frontierCalendar/jquery-frontier-cal-1.3.2.min.js"></script>
