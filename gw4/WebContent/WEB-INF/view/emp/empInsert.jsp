...
<form method="get" action="empInsertPro.do" name="userinput" onSubmit="goSubmit()">
  <table id="border_table" width="400" border="1" cellspacing="0" cellpadding="3" align="center" >
    ...
    <tr>
      <td>주민번호</td>
      <td><input type="text" size="15" name="emp_jumin"></td>
    </tr>
    <tr>
      <td>생년월일</td>
      <td><input type="text" size="15" id="emp_birth" name="emp_birth" onclick="fnPopUpCalendar(emp_birth,emp_birth,'yyyy-mm-dd')"></td>
    </tr>
    <tr>
      <td>연락처</td>
      <td><input type="text" size="15" name="emp_phone"></td>
    </tr>
    <tr>
      <td>이메일</td>
      <td>
        <input type="text" size="15" name="emp_email">
      </td>
    </tr>
    <tr>
      <td>최종학력</td>
      <td><input type="text" size="15"name="emp_acability"></td>
    </tr>
    <tr>
      <td>경력</td>
      <td><input type="text" size="15" name="emp_career"></td>
    </tr>
    <tr>
      <td>입사일자</td>
      <td><input type="text" size="15" id="emp_join" name="emp_join" onclick="fnPopUpCalendar(emp_join,emp_join,'yyyy-mm-dd')"></td>
    </tr>
    <tr>
      <td>은행명</td>
      <td><input type="text" size="15" name="emp_bank"></td>
    </tr>
    <tr>
      <td>계좌번호</td>
      <td><input type="text" size="15" name="emp_acnum"></td>
    </tr>
    <tr> 
      <th colspan="2" align="center"> 
          <input type="submit" class="button" value="등록" onclick="return checkIt()">
